...
<div class="row" style="margin-top: 60px">
    <div class="col-sm-6" style="background-image: url(../img/imgcarrusel2.jpeg); height: 430px; opacity: 0.9;">
        <h3 class="text-center my-5 mx-5 py-3" style=" border: 2.5px solid rgb(12, 12, 71); border-radius: 2%; box-shadow: 3px 3px 3px 3px rgba(0, 0, 0, 0.2); -webkit-text-stroke: 0.3px rgb(185, 185, 185); color: black; ">¡Ingresa, monitorea y registra las variables fisiológicas de los pacientes!</h3>
    </div>
    ...
    <div class="col-sm-5" style="display:block; margin: auto; position: relative; background-color: white; height: 440px; border: 2.5px solid rgb(12, 12, 71); border-radius: 5%; box-shadow: 3px 3px 3px 3px rgba(0, 0, 0, 0.2);">
        <h2 class="fw-bold mt-5" style="text-align: center">Iniciar sesión</h2>
